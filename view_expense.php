...
<body>
  ...
  <div id="mode_changer">
    <nav class="nav nav-tabs">
      <a class="flex-sm-fill text-sm-center nav-link" aria-current="page" href="add_income.php"
      ...
      <a class="flex-sm-fill text-sm-center nav-link active" href="view_expense.php" style="font-size: 1.5rem;">View
        Expense</a>
    ...
    <div style="text-align: center;font-size: 2.5rem;margin: 10px;padding: 20px;"><u>VIEW EXPENSE</u></div>
    <hr>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if(mysqli_num_rows($result)>0){
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          if($row["expense"]!=NULL){
            echo "<tr><td>Expense : ".$row["expense"]."</td>";
            echo "<td>Source : ".$row["e_source"]."</td>";
