...
<body>
  ...
  <div id="mode_changer">
    <nav class="nav nav-tabs">
      ...
      <a class="flex-sm-fill text-sm-center nav-link active" href="view_income.php" style="font-size: 1.5rem;">View
        Income</a>
    ...
    <div style="text-align: center;font-size: 2.5rem;margin: 10px;padding: 20px;"><u>VIEW INCOME</u></div>
    <hr>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if(mysqli_num_rows($result)>0){
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          if($row["income"]!=NULL){
            echo "<tr><td>INCOME : ".$row["income"]."</td>";
            echo "<td>Source : ".$row["i_source"]."</td>";
